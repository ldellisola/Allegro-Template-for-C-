...
namespace Allw {
	namespace Animation {
		...
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / float(this->width), this->scaledHeight / float(this->height), this->angle, 0);
		}

		void AllegroSprite::drawVerticallyMirrored(float x, float y)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / this->width, this->scaledHeight / this->height, this->angle, ALLEGRO_FLIP_VERTICAL);
		}

		void AllegroSprite::drawVerticallyMirrored(float x, float y, float angle)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / this->width, this->scaledHeight / this->height, degreesToRadians(angle), ALLEGRO_FLIP_VERTICAL);
		}

		void AllegroSprite::drawVerticallyMirrored(float x, float y, float height, float width)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), width / this->width, height / this->height, this->angle, ALLEGRO_FLIP_VERTICAL);
		}

		void AllegroSprite::drawHorizontallyMirrored(float x, float y)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / this->width, this->scaledHeight / this->height, this->angle, ALLEGRO_FLIP_HORIZONTAL);
		}

		void AllegroSprite::drawHorizontallyMirrored(float x, float y, float angle)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / this->width, this->scaledHeight / this->height, degreesToRadians(angle), ALLEGRO_FLIP_HORIZONTAL);
		}

		void AllegroSprite::drawHorizontallyMirrored(float x, float y, float height, float width)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), width / this->width, height / this->height, this->angle, ALLEGRO_FLIP_HORIZONTAL);
		}

		void AllegroSprite::draw(float x, float y, float angle)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), this->scaledWidth / this->width, this->scaledHeight / this->height, degreesToRadians(angle), 0);
		}

		void AllegroSprite::draw(float x, float y, float height, float width)
		{
			al_draw_scaled_rotated_bitmap(this->bitmap, this->width / 2.0, this->height / 2.0, x + (this->scaledWidth / 2.0),
				y + (this->scaledHeight / 2.0), width / this->width, height / this->height, this->angle, 0);
		}
