...
namespace Allw {
	namespace Factories {
		...
		*/
		...
		{
		public:
			static ALLEGRO_COLOR create(std::string color) { return al_color_name(color.c_str()); }
			static ALLEGRO_COLOR create(unsigned char r, unsigned char g, unsigned char b) { return al_map_rgb(r, g, b); }
			static ALLEGRO_COLOR create(unsigned char r, unsigned char g, unsigned char b, unsigned char a) { return al_map_rgba(r, g, b, a); }
			static void decode(ALLEGRO_COLOR& color, unsigned char&r, unsigned char & g, unsigned char & b) { al_unmap_rgb(color, &r, &g, &b); }
			static void decode(ALLEGRO_COLOR& color, unsigned char&r, unsigned char&g, unsigned char&b, unsigned char&a) { al_unmap_rgba(color, &r, &g, &b, &a); }
		};
